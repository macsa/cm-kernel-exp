...
EXPORT_SYMBOL(marimba_adie_codec_set_device_digital_volume);
...
EXPORT_SYMBOL(marimba_adie_codec_set_device_analog_volume);
...
EXPORT_SYMBOL(marimba_adie_codec_setpath);

u32 marimba_adie_codec_freq_supported(
				struct adie_codec_dev_profile *profile,
				u32 requested_freq)
{
	u32 i, rc = -EINVAL;
...
EXPORT_SYMBOL(marimba_adie_codec_freq_supported);

int marimba_adie_codec_enable_sidetone(
...
EXPORT_SYMBOL(marimba_adie_codec_enable_sidetone);
...
int marimba_adie_codec_proceed_stage(struct adie_codec_path *path_ptr,
						u32 state)
{
...
EXPORT_SYMBOL(marimba_adie_codec_proceed_stage);
...
EXPORT_SYMBOL(marimba_adie_codec_open);
...
EXPORT_SYMBOL(marimba_adie_codec_close);
